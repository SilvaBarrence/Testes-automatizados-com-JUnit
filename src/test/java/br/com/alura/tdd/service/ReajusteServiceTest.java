...
public class ReajusteServiceTest {
	...
	public void  reajusteQuinzePorCentoDesempenhoBom() {
		ReajusteService service = new ReajusteService();
		Funcionario funcionario = new Funcionario("Jorge", LocalDate.now(), new BigDecimal("1000"));
	...
	public void  reajusteVintePorCentoDesempenhoOtimo() {
		ReajusteService service = new ReajusteService();
		Funcionario funcionario = new Funcionario("Fernando", LocalDate.now(), new BigDecimal("1000"));
